...
func (r CreateBerita) ToEntity() (data entity.BeritaEntity) {
...
func (r UpdateBerita) ToEntity() (data entity.BeritaEntity) {
	data = entity.BeritaEntity{
		Title:             r.Title,
		SubTitle:          r.SubTitle,
		Tag:               r.Tag,
...
func ToPayload(data entity.BeritaEntity) (response ReadBerita) {
	response = ReadBerita{
